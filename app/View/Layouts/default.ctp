                ...
                <div class="row">
                    ...
                    <div class="col col s8 m8 l8">
                        <ul id="profile-dropdown" class="dropdown-content">
                            <li><a href="#" style='font-size:0.6em;'><?php echo $datosLogeo['0']['Secorganization']['name'];?></a>
                            </li>
                            <li><a href="#" style='font-size:0.6em;'><?php echo $datosLogeo['0']['Secproject']['name'];?></a>
                            </li>
                            <li><font><?php echo $this->Html->link(__('Cambiar Contraseña',true),
                array('controller'=> 'Secpeople', 'action'=>'modifiedpassworduser'), array('style'=>'font-size:0.6em;','escape'=>false),null);?></font>
                            </li>
                            <li><font><?php echo $this->Html->link(__('Cambiar Sesión',true),
                array('controller'=> 'Secassigns', 'action'=>'asignacionget',$datosLogeo['0']['Secperson']['username'],$datosLogeo['0']['Secperson']['password']), array('style'=>'font-size:0.8em;','escape'=>false),null);?></font>
                            </li>
                        ...
                        <p class="user-roal" style='font-size:0.6em;'><?php echo $datosLogeo['0']['Secrole']['name'];?></p>
                    </div>
                </div>
                </li> 
                <?php if(!empty($menu)):?>        
