...
<?php echo $this->Form->create('Arbperson'); ?>
	<fieldset>
		<legend><?php echo __('Edit Arbperson'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Arbperson.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('Arbperson.id')))); ?></li>
