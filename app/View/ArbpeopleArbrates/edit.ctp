...
<?php echo $this->Form->create('ArbpeopleArbrate'); ?>
	<fieldset>
		<legend><?php echo __('Edit Arbpeople Arbrate'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ArbpeopleArbrate.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('ArbpeopleArbrate.id')))); ?></li>
